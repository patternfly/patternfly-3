...
To do this first change directories, or
...
Since Patternfly is shrink wrapped, npm 3 will install all necessary development packages into `node_modules/patternfly/node_modules`. At this point, the NPM or gruntjs tasks are available for use such as starting a local development server or building the master CSS file.
...
Test pages are generated using [Jekyll](http://jekyllrb.com/). Ensure [Ruby](https://www.ruby-lang.org/en/documentation/installation/) is installed and available then run:
