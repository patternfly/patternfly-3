See [http://getbootstrap.com/javascript/#collapse](http://getbootstrap.com/javascript/#collapse) for complete accordion documentation.


#### html source code

```html
<div class="panel-group" id="fixed-accordion" style="height: 350px; overflow-y: hidden;">
  <div class="panel panel-default">
    ...
    <div id="fixedCollapseFive" class="panel-collapse collapse in">
  ...
  <div class="panel panel-default">
    <div class="panel-heading" data-component="collapse-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#fixed-accordion" href="#fixedCollapseNine" class="collapsed">
          Suspendisse lectus tortor
        </a>
      </h4>
    </div>
    <div id="fixedCollapseNine" class="panel-collapse collapse">
      <div class="panel-body">
  ...
  <div class="panel panel-default">
    <div class="panel-heading" data-component="collapse-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#fixed-accordion" href="#fixedCollapseTen" class="collapsed">
          Velit mauris
        </a>
      </h4>
    </div>
    <div id="fixedCollapseTen" class="panel-collapse collapse">
      <div class="panel-body">
  ...
  <div class="panel panel-default">
    <div class="panel-heading" data-component="collapse-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#fixed-accordion" href="#fixedCollapseEleven" class="collapsed">
          Aliquam convallis
        </a>
      </h4>
    </div>
    <div id="fixedCollapseEleven" class="panel-collapse collapse">
      <div class="panel-body">
  ...
  <div class="panel panel-default">
    <div class="panel-heading" data-component="collapse-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#fixed-accordion" href="#fixedCollapseTwelve" class="collapsed">
          Vulputate dictum
        </a>
      </h4>
    </div>
    <div id="fixedCollapseTwelve" class="panel-collapse collapse">
      <div class="panel-body">
